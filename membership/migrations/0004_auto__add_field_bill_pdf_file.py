...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.pdf_file'
        db.add_column(u'membership_bill', 'pdf_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.pdf_file'
        db.delete_column(u'membership_bill', 'pdf_file')
    ...
    models = {
        ...
        u'membership.billingcycle': {
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 4, 0, 0)'}),
