...
urlpatterns = [
    ...
    url(r'memberships/request_dissociation_billingcycle_end/(\d+)/$',
        membership.views.membership_request_dissociation_billingcycle_end,
        name='membership_request_dissociation_billingcycle_end'),
    ...
    url(r'memberships/dissociation_requested-plain/$', membership.views.dissociation_requested_member_object_list,
        {'order_by': ('id',),
         'template_name': 'membership/membership_list_plaintext.html',
         'context_object_name': 'member_list'},
