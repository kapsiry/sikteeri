...
first_names = [
    ...
    u"Kulta-Into", u"Kroisos", u"Velmu", u"Pelle", u"Hannu", u"Hansu",
    u"Mummo", u"Milla", u"Toope", u"Mortti", u"Vertti", u"Hessu", u"Polle",
    u"Heluna", u"Klaara", u"Sisu", u"Matami", u"Tiku", u"Tiku", u"Veli",
    u"Sepe", u"Tipsu", u"Timotei", u"Bumba", u"Dumbo", u"Jopi", u"Neiti"]
...
municipalities = [
    u"Ankkalinna", u"Hanhivaara", u"Mummola", u"Duckburg", u"Kaukastan",
    u"Takametsä", u"Timpuktu", u"Toisaala", u"Mäentaus", u"Vuorisola",
    u"Mikälie", u"Jokimutka"]

# Fictional streets
street_addresses = [
    u"Paratiisitie", u"Onnitie", "Pääkatu", "Sivukuja", u"Jullentie",
    u"Säiliökatu", u"Rahakuja", u"Rosvotie", u"Hassukuja", u"Puutarhakatu",
    u"Lähitie"]
