...
urlpatterns = [
    ...
    url(r'application/supporting/$', membership.views.supporting_organization_application,
        name='supporting_organization_application'),
    url(r'application/supporting/add_contact/(\w+)/$', membership.views.supporting_application_add_contact,
        name='supporting_application_add_contact'),
    url(r'application/supporting/review/$', membership.views.supporting_application_review,
        name='supporting_application_review'),
    url(r'application/supporting/save/$', membership.views.supporting_application_save,
        name='supporting_application_save'),
    url(r'application/supporting_person/$', membership.views.supporting_person_application,
        name='supporting_person_application'),
    ...
    url(r'memberships/unpaid_paper_reminded/$', membership.views.unpaid_paper_reminded,
...
urlpatterns += [
    ...
    url(r'application/supporting/success/$',
        TemplateView.as_view(template_name='membership/new_organization_application_success.html'),
        name='new_supporting_application_success'),
    url(r'application/supporting_person/success/$',
        TemplateView.as_view(template_name='membership/new_person_application_success.html'),
        name='new_supporting_person_application_success'),
